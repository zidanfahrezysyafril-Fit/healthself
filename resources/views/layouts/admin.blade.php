...
<head>
    ...
    <title>@yield('title', 'Dashboard') – Admin HealthSelf</title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .sidebar {
            ...
            background: linear-gradient(180deg, #4A0000 0%, #800000 100%); /* Deep Maroon */
            background-image: radial-gradient(circle at top right, rgba(255, 100, 100, 0.1), transparent 300px), linear-gradient(180deg, #3a0000 0%, #600000 100%);
        ...
        .nav-item.active .nav-icon { 
            background: white; 
            color: #800000; box-shadow: 0 4px 15px rgba(255, 255, 255, 0.2); 
        }
        ...
        .topbar-badge {
            background: #fee2e2; color: #b91c1c; font-size: 0.75rem; font-weight: 800;
        ...
        .btn-primary { background: linear-gradient(135deg, #800000, #500000); color: white; box-shadow: 0 4px 15px rgba(128, 0, 0, 0.3); }
        .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 8px 25px rgba(128, 0, 0, 0.4); }
        ...
        .form-control:focus { border-color: #800000; background: #fff; box-shadow: 0 0 0 4px rgba(128,0,0,0.08); transform: translateY(-1px); }
        .form-control.error { border-color: #ef4444; }
        .form-error { color: #ef4444; font-size: 0.8rem; margin-top: 4px; }
        .password-container { position: relative; display: flex; align-items: center; }
        .password-toggle { position: absolute; right: 14px; background: none; border: none; cursor: pointer; color: #6b7280; padding: 0; display: flex; align-items: center; justify-content: center; transition: color 0.2s; }
...
<div class="sidebar">
    <div class="sidebar-brand">
        <div style="display:flex; justify-content:center; margin-bottom:18px;">
            <div style="background: white; padding: 6px; border-radius: 22px; box-shadow: 0 8px 30px rgba(0,0,0,0.4); display: inline-flex;">
                <img src="{{ asset('images/logo.jpg') }}" alt="Logo" style="width: 58px; height: 58px; border-radius: 16px; object-fit:cover;">
            </div>
        </div>
        ...
        <div style="margin-top: 18px; font-size: 0.75rem; background: rgba(255,255,255,0.15); display: inline-block; padding: 6px 16px; border-radius: 10px; color: #ffffff; font-weight: 800; letter-spacing: 0.5px; border: 1px solid rgba(255,255,255,0.1);">👑 Panel Admin</div>
    </div>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('admin.users.index') }}" class="nav-item {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">
            <div class="nav-icon"><svg style="width:20px;height:20px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg></div> Pengguna
        </a>
        <a href="{{ route('admin.artikel.index') }}" class="nav-item {{ request()->routeIs('admin.artikel.*') ? 'active' : '' }}">
            <div class="nav-icon"><svg style="width:20px;height:20px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path></svg></div> Artikel
        ...
        <div class="nav-label">Aksi Cepat</div>
        <a href="{{ route('admin.users.create') }}" class="nav-item">
            <div class="nav-icon"><svg style="width:20px;height:20px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path></svg></div> Buat Akun Konselor
        </a>
...
<div class="main-content">
    <div class="topbar">
        ...
        <div class="topbar-right">
            <span class="topbar-badge">👑 Admin Access</span>

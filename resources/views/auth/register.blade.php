...
<head>
    ...
    <title>Daftar Akun – HealthSelf</title>
    <meta name="description" content="Daftar ke platform HealthSelf untuk mengakses konsultasi kesehatan digital dan artikel kesehatan.">
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .form-card {
            background: #ffffff;
            width: 100%;
            max-width: 480px; /* Diperlebar sedikit agar muat 2 kolom */
            padding: 32px 32px;
            border-radius: 20px;
...
<div class="login-wrapper">
    ...
    <div class="login-right">
        <div class="form-card">
            ...
            <p class="login-subtitle">Buat akun baru untuk mulai berkonsultasi</p>
            ...
            <form method="POST" action="{{ route('register.post') }}">
                ...
                <div style="text-align:center; margin-top:20px; font-size:0.85rem; color:#6b7280;">
                    Sudah punya akun? <a href="{{ route('login') }}" style="color:#800000; font-weight:700; text-decoration:none;">Masuk di sini</a>
                </div>
            </form>
        </div>
    </div>
...
<script>
    function togglePassword(inputId, btn) {
        ...
        // Ganti icon svg (eye vs eye-slash)
        if (type === 'text') {
